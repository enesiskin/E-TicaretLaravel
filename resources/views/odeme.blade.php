                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="adsoyad" name="adsoyad" class="form-control" required value="{{auth()->user()->adsoyad}}">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="adres">Adres</label>
                                <input type="text" id="adres" name="adres" class="form-control" required value="{{$kullanici_detay->adres}}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="telefon" name="telefon" class="form-control telefon" required value="{{$kullanici_detay->telefon}}" >
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="ceptelefonu">Cep Telefonu</label>
                                <input type="text" id="ceptelefonu" name="ceptelefonu" class="form-control telefon" required value="{{$kullanici_detay->ceptelefonu}}" >
                            </div>
                        </div>
                    </div>
